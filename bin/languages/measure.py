...
def main(args):
    ...
    elif setup.inf_strat == 'brochhagen':
        informativeness_measurer = BrochhagenInformativenessMeasurer(universe)
    else:
        raise ValueError('{0} is not a valid informativeness strategy.'.format(setup.inf_strat))
    ...
    print("Dumping dill as ",'informativeness_{0}.dill'.format(setup.inf_strat))
