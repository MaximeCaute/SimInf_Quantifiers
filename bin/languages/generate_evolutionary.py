...
from siminf.languages.informativeness_measurer import get_informativeness_measurer
...
def main(args):
    ...
    measure_informativeness = get_informativeness_measurer(setup.inf_strat, universe)
    ...
    file_util.dump_dill(dominating_informativeness, 'informativeness_{0}.dill'.format(setup.inf_strat))
